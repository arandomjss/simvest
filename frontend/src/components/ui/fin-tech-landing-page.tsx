...
export default function MoneyflowLandingPage() {
  return (
    <div className="min-h-screen w-full bg-[#F3F5F7] font-sans">
      {/* Fonts - Standardized for TSX */}
      <style dangerouslySetInnerHTML={{ __html: `
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap');
        :root { --font-jakarta: 'Plus Jakarta Sans', ui-sans-serif, system-ui; }
      ...
      {/* Hero area */}
      <div className="mx-auto grid w-full max-w-[1180px] grid-cols-1 gap-12 px-4 pb-14 md:grid-cols-2 md:px-0">
        {/* Left: headline */}
        <div className="flex flex-col justify-center space-y-8 pr-2">
          <div>
            ...
            <p className="mt-6 max-w-md text-slate-600 text-lg leading-relaxed">
          ...
          <div className="flex items-center gap-4">
            <SoftButton className="px-8 py-3 text-base">
              Open Account <ArrowUpRight className="ml-1 inline h-5 w-5" />
            </SoftButton>
          </div>
          ...
          <div className="mt-8 flex items-center gap-8 opacity-70">
            <span className="text-xs font-bold text-slate-500 tracking-widest uppercase">Trusted By</span>
            <div className="flex items-center gap-8 text-slate-400">
              <span className="font-bold text-lg">loom</span>
              <span className="font-bold text-lg">HubSpot</span>
              <span className="font-bold text-lg">ramp</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative col-span-1 overflow-hidden rounded-2xl bg-gradient-to-b from-emerald-900 to-emerald-800 p-8 text-emerald-50 shadow-xl"
          >
            ...
            <div className="relative flex h-full flex-col justify-between min-h-[160px]">
              <div className="flex items-center gap-3">
                <div className="rounded-full bg-emerald-700/60 p-2.5 ring-1 ring-white/10">
                  <ShieldCheck className="h-5 w-5" />
                </div>
                <span className="text-xs uppercase tracking-widest font-semibold text-emerald-200">Security First</span>
              </div>
              <div className="mt-8 text-2xl font-medium leading-snug text-emerald-50/95">
                Fraud and security
                <br /> keep your money safe
              </div>
              <motion.div
                className="absolute right-0 top-0 h-16 w-16 rounded-full bg-emerald-400/20"
          ...
          <motion.div
            ...
            className="relative col-span-1 min-h-[220px] overflow-hidden rounded-2xl bg-gradient-to-b from-teal-400 to-emerald-500 p-8 text-white shadow-xl"
          >
            <div className="pointer-events-none absolute -right-10 -top-12 opacity-80">
              <Planet />
            </div>
            <div className="relative mt-auto pt-24">
              <div className="text-sm font-semibold text-white/80 uppercase tracking-widest mb-2">Currencies</div>
          ...
          <motion.div
            ...
            className="col-span-1 rounded-2xl bg-white p-8 text-slate-800 shadow-xl ring-1 ring-slate-100"
          >
            <div className="text-sm font-semibold text-slate-400 uppercase tracking-widest mb-3">Growth Revenue</div>
            <div className="flex items-baseline gap-2">
              <div className="text-4xl font-bold tracking-tight text-slate-900">$50,240</div>
              <div className="text-sm font-semibold text-slate-400">USD</div>
            </div>
            <div className="mt-2 text-sm font-semibold text-emerald-600 flex items-center">
              <span className="mr-1">↑</span> 0.024% vs last month
            </div>
            <MiniBars />
          </motion.div>
      ...
      <footer className="mx-auto w-full max-w-[1180px] px-4 py-12 text-center text-sm font-medium text-slate-400 md:px-0 border-t border-slate-200 mt-12">
